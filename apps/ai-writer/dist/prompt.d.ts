...
export declare function renderPrompt(recipe: string, promptTemplate: string, data: any): string;
...
export declare function enhancePromptDataWithFunctionsIfAvailable(recipe: string, data: any): void;
