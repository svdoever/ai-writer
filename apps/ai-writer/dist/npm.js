...
exports.npmCommand = exports.installPackage = exports.installPackages = void 0;
const logger = __importStar(require("loglevel"));
const child_process_1 = require("child_process");
function installPackages(packages) {
    return __awaiter(this, void 0, void 0, function* () {
        Object.keys(packages).map((packageName) => __awaiter(this, void 0, void 0, function* () {
            logger.debug(`Installing npm package '${packageName}'`);
            const version = packages[packageName];
            yield installPackage(packageName, version);
        }));
    });
}
...
function npmCommand(command) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            // Install the package
            (0, child_process_1.exec)(`${command}`, (err) => __awaiter(this, void 0, void 0, function* () {
                if (err) {
                    reject(err);
                }
                else {
