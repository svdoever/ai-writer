...
exports.ensureFolderForFile = exports.ensureFolder = void 0;
...
function ensureFolder(folderPath) {
    try {
        ...
        logger.debug(`Folder '${folderPath}' ensured.`);
    }
    catch (error) {
...
function ensureFolderForFile(filepath) {
    try {
        ...
        fs.ensureDirSync(folderPath);
        logger.debug(`Folder '${folderPath}' ensured for file '${filepath}'.`);
    }
    catch (error) {
...
exports.ensureFolderForFile = ensureFolderForFile;
