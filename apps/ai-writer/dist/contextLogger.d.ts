...
export declare function logOptions(options: Record<string, string | boolean>): void;
export declare function logExpandedOptions(options: Record<string, string | boolean>): void;
